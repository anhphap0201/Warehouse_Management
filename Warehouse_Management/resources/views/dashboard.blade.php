                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-4">
                            <div class="flex flex-wrap gap-3">
                                ...
                                <a href="{{ route('stock-movements.index') }}" class="inline-flex items-center px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium rounded-md transition-colors">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
